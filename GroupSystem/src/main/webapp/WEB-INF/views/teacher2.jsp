...
${pageContext.request.serverPort}${pageContext.request.contextPath}/">
    ...
    <script src="js1/hm.js"></script><script src="js1/lib.min.js" id="seajsnode"></script>
...
<script charset="utf-8" async="" src="js1/nav.js"></script><script charset="utf-8" async="" src="js1/next.js"></script><script charset="utf-8" async="" src="js1/announce.js"></script><script charset="utf-8" async="" src="js1/portal.js"></script><script charset="utf-8" src="chrome-extension://jgphnjokjhjlcnnajmfjlacjnjkhleah/js1/btype.js"></script><script charset="utf-8" async="" src="js1/student_service.js"></script><script charset="utf-8" async="" src="js1/nav.js(1)"></script><script charset="utf-8" async="" src="js1/shoot.js"></script><script charset="utf-8" async="" src="js1/template.js"></script><script charset="utf-8" async="" src="js1/next.js(1)"></script><script charset="utf-8" async="" src="js1/info.js"></script><script charset="utf-8" async="" src="js1/announcement.js"></script><script charset="utf-8" async="" src="js1/task.js"></script><script charset="utf-8" async="" src="js1/calendar.js"></script><script charset="utf-8" async="" src="js1/user_service.js"></script><style id="style-1-cropbar-clipper">/* Copyright 2014 Evernote Corporation. All rights reserved. */
    ...
    <div class="gxb-header-content clear-fix">
        ...
        <div class="gxb-header-right">
            ...
            <div class="gxb-user-info" id="gxbUser">
                ...
                <span class="text">
                    <span class="user-name linkPage" title="xjtu3115393007" text="UserVo(userId=1233428, userName=xjtu3115393007, name=韩翔辉, type=null, tenantId=, username=xjtu3115393007, gender=null, mobile=13140917139, email=null, groupName=null, avatar_url=https://gxbfile-gs.gaoxiaobang.com/uploads/avatar/link/4995ff94707a463cb559e15e67de8c34.png, confirmStatus=20, roleUserList=null, maxViewTime=null, learnStatus=null, schoolDepartment=null, major=null, schoolClass=null, no=null, studentList=null, openId=null, userCenterUserId=1233428)"> 小明老师</span>
...
<div class="gxb-left clear-fix">
    ...
    <div class="menu-wrap" id="stuMenu"> <div class="course-nav course-nav-margin"> <ul class="nav nav-margin">  <li menu_id="1" class="active"> <i class="icon icon-course"></i> <a href="javascript:navTo(1)" class="deleteLeft"> 公告 </a> </li>  <li menu_id="11" class=""> <i class="icon icon-result"></i> <a href="javascript:navTo(11)" class="deleteLeft"> 成员列表 </a> </li>  <li menu_id="2" class=""> <i class="icon icon-chapter"></i> <a href="javascript:navTo(2)" class="deleteLeft"> 群组动态 </a> </li>  <li menu_id="3" class=""> <i class="icon icon-quiz"></i> <a href="javascript:navTo(3)" class="deleteLeft"> 讨论区 </a> </li>  <li menu_id="9" class=""> <i class="icon icon-emax"></i> <a href="javascript:navTo(9)" class="deleteLeft"> 群库存 </a> </li>  <li menu_id="5" class=""> <i class="icon icon-emax"></i> <a href="javascript:navTo(5)" class="deleteLeft"> 设置群组 </a> </li> </ul> </div></div>
</div>
<script>
    var menuList = [{
        menuId: 1,
...
<div class="unit-announcement" style="display: none"> <div> <p>关于成绩考核的重要提醒！</p> <a> 本课程于<span class="announcement-startAt">2015年11月25 08:00日</span>开课， 将于<span class="announcement-concludeAt">2016年02月29 23:59日</span>结课， 请同学在此期间进行课程学习，逾期后的学习将不计入成绩。</a> </div> </div>
<div class="announcements-list" id="announceList">  <div class="announcement-unit"> <h2><em class="gxb-read-status gxb-hide">未读</em><span>VR内容体验通告</span></h2> <div class="update-time">发布日期：2017-11-14 18:34</div> <div class="announcement-content"> <p>&nbsp; &nbsp; &nbsp; 本学期新购入多个VR内容，同学们可以通过下载客户端进行体验。</p> <br> </div>  </div>  <div class="announcement-unit"> <h2><em class="gxb-read-status gxb-hide">未读</em><span>二、辅导答疑方式</span></h2> <div class="update-time">发布日期：2017-11-14 16:25</div> <div class="announcement-content open"> <p>1. 在线答疑：平台讨论区</p><p>&nbsp;&nbsp;&nbsp;&nbsp; 在线问答路径：在讨论区提出问题；</p><p>&nbsp;&nbsp;&nbsp;&nbsp; 在线答疑时间：10:00-18:00</p><p>&nbsp;</p><p>2. 邮件答疑：</p><p>&nbsp;&nbsp;&nbsp;&nbsp; 邮箱地址：clli@uniquedu.com</p><p>&nbsp;&nbsp;&nbsp;&nbsp; 邮件答疑时间：10:00-18:00</p><p>&nbsp;&nbsp;&nbsp;&nbsp; 应答时间段：10:00-18:00发邮件，30分钟内回复，非工作时间24小时内回复</p><p>&nbsp;</p><p>3.电话答疑：</p><p>&nbsp;&nbsp;&nbsp;&nbsp; 专线电话：010-58472957</p><p>&nbsp;&nbsp;&nbsp;&nbsp; 电话答疑时间段：10:00-18:00</p><p>&nbsp;&nbsp;&nbsp;&nbsp; 应答时间段：10:00-18:00电话即时解答</p><p>&nbsp;</p><p>备注：此课程节假日不提供辅导答疑，以上只针对工作日。</p> <br> </div>  <i class="open-close-status open-close open"></i>  </div>  <div class="announcement-unit"> <h2><em class="gxb-read-status gxb-hide">未读</em><span>一、学前必读</span></h2> <div class="update-time">发布日期：2015-11-23 16:25</div> <div class="announcement-content"> <p>大家好，我是《编程算法基础》课程的导学老师。该课程将于11月25日（周三）上午8点为大家准时开课，课程的截止时间是1月22日（周五）。在学习过程中同学们除了要观看每一章课程视频外，还需要注意每一章下方需要大家完成的作业（讨论、作业、测验统称为作业），大家要知道提交作业的截止时间，不要错过，错过的话系统将不再接收，这部分的成绩将会为0。以上是大家学习此门课程需要注意的地方，祝大家取得好成绩；<br></p> <br> </div>  <i class="open-close-status open-close"></i>  </div>  <div class="announcement-unit"> <h2><em class="gxb-read-status gxb-hide">未读</em><span>致所有加入该课程的同学</span></h2> <div class="update-time">发布日期：2015-11-23 14:06</div> <div class="announcement-content"> <p>亲爱的同学们,你们好!</p><p style="text-indent:2em">从今天开始，我们将和您一起开始《编程算法基础【西安交大-XJ15Y1班】》的课程学习了，我们将带您感受《编程算法基础【西安交大-XJ15Y1班】》的美丽，进《编程算法基础【西安交大-XJ15Y1班】》领域的殿堂。
...
</p><p>欢迎您的加入,祝学习进步</p><p>《编程算法基础【西安交大-XJ15Y1班】》教学团队</p> <br> </div>  <i class="open-close-status open-close"></i>  </div> </div>
</div>
<script>
var announceList =[{"editorId":"","contextType":"Course","contextId":"2858","detail":"<p>&nbsp; &nbsp; &nbsp; 考虑到本门课程作业量很大，特将作业截止时间延长至2016年2月29日，未在截止日期完整的作业部分将按零处理，请同学们按时完成任务。</p>","id":"918","position":"","time":"2016-01-14 18:34","permalink":"","title":"作业延迟工作","userId":"1173690","status":""},{"editorId":"","contextType":"Course","contextId":"2858","detail":"<p>1. 在线答疑：平台讨论区</p><p>&nbsp;&nbsp;&nbsp;&nbsp; 在线问答路径：在讨论区提出问题；</p><p>&nbsp;&nbsp;&nbsp;&nbsp; 在线答疑时间：10:00-18:00</p><p>&nbsp;</p><p>2. 邮件答疑：</p><p>&nbsp;&nbsp;&nbsp;&nbsp; 邮箱地址：clli@uniquedu.com</p><p>&nbsp;&nbsp;&nbsp;&nbsp; 邮件答疑时间：10:00-18:00</p><p>&nbsp;&nbsp;&nbsp;&nbsp; 应答时间段：10:00-18:00发邮件，30分钟内回复，非工作时间24小时内回复</p><p>&nbsp;</p><p>3.电话答疑：</p><p>&nbsp;&nbsp;&nbsp;&nbsp; 专线电话：010-58472957</p><p>&nbsp;&nbsp;&nbsp;&nbsp; 电话答疑时间段：10:00-18:00</p><p>&nbsp;&nbsp;&nbsp;&nbsp; 应答时间段：10:00-18:00电话即时解答</p><p>&nbsp;</p><p>备注：此课程节假日不提供辅导答疑，以上只针对工作日。</p>","id":"615","position":"","time":"2015-11-23 16:25","permalink":"","title":"二、辅导答疑方式","userId":"1173690","status":""},{"editorId":"","contextType":"Course","contextId":"2858","detail":"<p>大家好，我是《编程算法基础》课程的导学老师。该课程将于11月25日（周三）上午8点为大家准时开课，课程的截止时间是1月22日（周五）。在学习过程中同学们除了要观看每一章课程视频外，还需要注意每一章下方需要大家完成的作业（讨论、作业、测验统称为作业），大家要知道提交作业的截止时间，不要错过，错过的话系统将不再接收，这部分的成绩将会为0。以上是大家学习此门课程需要注意的地方，祝大家取得好成绩；<br></p>","id":"614","position":"","time":"2015-11-23 16:25","permalink":"","title":"一、学前必读","userId":"1173690","status":""},{"contextType":"Course","contextId":"2858","detail":"<p>亲爱的同学们,你们好!</p><p style=\"text-indent:2em\">从今天开始，我们将和您一起开始《编程算法基础【西安交大-XJ15Y1班】》的课程学习了，我们将带您感受《编程算法基础【西安交大-XJ15Y1班】》的美丽，进《编程算法基础【西安交大-XJ15Y1班】》领域的殿堂。\n</p><p>课程简介:</p><p style=\"text-indent:2em\"> 《编程算法基础》课程通过循序渐进的方式剖析各种常见编程任务的求解思路和基本算法，使初学者快速地学习到常见逻辑、算法的运作原理，掌握基本编程技巧，为后续课程学习打下坚实基础。\r\n\r\n       本课程通过大量示范，在启发思维、开拓视野的同时，有意识地去逐渐综合运用多种算法和设计理念，为初学者开辟一条通往较熟练编程的具体道路。</p><p>注意事项:</p><p style=\"text-indent:2em\">该课程以网络MOOC形式进行授课、包括视频、作业、讨论、测验等教学环节，学员应本人独立完成教学内容，严禁抄袭、他人代答等行为。\n</p><p>欢迎您的加入,祝学习进步</p><p>《编程算法基础【西安交大-XJ15Y1班】》教学团队</p>","time":"2015-11-23 14:06","title":"致所有加入该课程的同学"}];
var classinfo ={"classId":"2858","concludeAt":"2016-02-29 23:59","className":"编程算法基础【西安交大-XJ15Y1班】","teachMode":"10","type":"Class","startAt":"2015-11-25 08:00"};
...
<div class="gxb-sidebar" style="margin-top: 20px;">
  <div class="gxb-sidebar-list expiring">
    ...
    <ul id="expiring">  <div class="no-expire-task"><div class="gxb-noTask"></div></div> </ul>
  </div>
  <div class="gxb-sidebar-list expired">
    <h3>过期任务</h3>
    <ul id="expired">  <div class="no-expire-task"><div class="gxb-noTask"></div></div> </ul>
  </div>
...
<script>
    ...
    $(function () {
        ...
        window.setInterval(function(){
            gxb._.ajax({url: '/keepalive',type: 'GET'});
        },15*60*1000);
...
<div id="gxb_ui_home"></div><div class="studentBootstrap"> <div class="bootstrapMain"> <p class="bootstrap_close"></p> <p class="bootstrap_know"></p> </div> </div></body></html>