                    ...
                    <div class="menu-wrap" id="stuMenu">
                        <div class="course-nav course-nav-margin">
                            <ul class="nav nav-margin">
                                ...
                                <li ng-class="{true:&#39;active&#39;,false:&#39;&#39;}[menu==3]" ng-click="menu=3" menu_id="2" class=""> <i class="icon icon-chapter"></i> <a href="javascript:navTo(2)" class="deleteLeft"> 群组动态 </a> </li>
                                <li ng-class="{true:&#39;active&#39;,false:&#39;&#39;}[menu==4]" ng-click="menu=4" menu_id="3" class=""> <i class="icon icon-quiz"></i> <a href="javascript:navTo(3)" class="deleteLeft"> 讨论区 </a> </li>
                                <li ng-class="{true:&#39;active&#39;,false:&#39;&#39;}[menu==5]" ng-click="menu=5" menu_id="9" class=""> <i class="icon icon-emax"></i> <a href="javascript:navTo(9)" class="deleteLeft"> 群库存 </a> </li>
                                <li ng-class="{true:&#39;active&#39;,false:&#39;&#39;}[menu==6]" ng-click="menu=6" menu_id="5" class=""> <i class="icon icon-emax"></i> <a href="javascript:navTo(5)" class="deleteLeft"> 设置群组 </a> </li>
                            </ul>
                        </div>
                    </div>
                </div>
...
-->
                                <div>
                                    <button class="stubtn" onClick="">添加</button>
                                    <button class="stubtn" onClick="">批量添加</button>
                                    <button class="stubtn" onClick="">删除</button>
                                    <button class="stubtn" onClick="">全选</button>
                                </div>
