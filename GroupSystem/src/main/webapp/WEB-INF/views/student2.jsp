...
<a href="group/myGroups">我加入的群</a>
 ...
 --%>
    ...
    <script src="js/gxb_log.js"></script>
    <script>
...
<script>
    (function () {
        ...
        $('.download_close').click(function(){
            ...
            $(".downloadApp").animate({left:'-100%'},500);
            $('.gxb_app').animate({left:'0%'},1000);
        });

        $('.gxb_app').click(function(){
            $('.gxb_app').animate({left:'-158px'},500);
            $(".downloadApp").animate({left:'0%'},1000);
        })
...
<!-- uiView:  --><div class="content_body_bottom_height default-body-height ng-scope" data-ui-view="" style="height: auto;"><div ng-bind-html="$userCenterHTML" class="ng-binding ng-scope"><div class="user">    <div class="w1200">        <div class="setting" ispart="true" part-data="" style="height: 1200px;"><div class="setting" data-key="webpart_383428" data-api="/user/api" data-mapper="" style="height: 1200px;">
    <dl>
        <dt>
...
</div></div>        <div class="setting_main" style="height: 1200px;">            <div class="nosetting">            
<div ui-view="user_setting_view" class="ng-scope"><div class="nosettingFour ng-scope">
    <div class="setting_self">
        <ul class="nav">
            <li ng-class="{true:&#39;current&#39;,false:&#39;&#39;}[menu==1]" ng-click="menu=1;my_course()" class="current">全部群组</li>
            <li ng-class="{true:&#39;current&#39;,false:&#39;&#39;}[menu==2]" ng-click="menu=2;study_rili()">创建群组</li>
			<li ng-class="{true:&#39;current&#39;,false:&#39;&#39;}[menu==2]" ng-click="menu=2;study_rili()">我的库存</li>
        </ul>
    </div>
</div>
...
<div class="nosettingOne ng-scope" ng-show="menu==1">
    ...
    <!--有认证学分课-->
    <div class="authCourse" ng-hide="hasNoSelectedCourse">
       <div class="myhome_Course ng-scope" ng-repeat="item in data">
            <a href="javascript:void(0)">
                <div class="myhome_Course_photo" style="background:url(&#39;https://gxbfile-gs.gaoxiaobang.com/uploads/course_image/link/160440/____.png&#39;) no-repeat center center;background-size:cover;">
                    <div class="classTips ng-hide" ng-show="item.droppingSelf == 1"><p class="exitClass" ng-click="drawsClass($event,item.classId)">退课</p></div>
                </div>
            </a>
            ...
            <div class="myhome_Course_text" ng-hide="(item.creditScore  | gxb_digital_score)&gt;0">
                <p style="width:332px">	<a ng-href="/#/courses/detail/2856" class="ng-binding" href="">101班</a></p>
                <p class="ng-binding">群公告：xxxxxx</p>
        ...
        </div><div class="myhome_Course ng-scope" ng-repeat="item in data">
            <a href="javascript:void(0)">
...
</div><!-- end ngIf: guessyoulikeType == 10 --></div>    </div> </div></div></div>
